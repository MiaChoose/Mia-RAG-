        ...
        try:
            ...
            result = evaluate(
                Dataset.from_dict({
                    'question': questions,
                    'answer': answers,
                    'contexts': [[str(y) for y in x] if isinstance(x, list) else [str(x)] for x in contexts],
                    'ground_truth': ground_truths
                }),
        ...
        try:
            ...
            result = evaluate(
                Dataset.from_dict({
                    'question': [question],
                    'answer': [answer],
                    'contexts': [[str(y) for y in contexts] if isinstance(contexts, list) else [[str(contexts)]]],
                    'ground_truth': [ground_truth]
                }),
                metrics=self.metrics,
                llm=self.llm,
